...
def main():
    ...
    events_result = service.events().list(calendarId='mirantis.com_iqrn5epep3dunclian026s4c6g@group.calendar.google.com', timeMin=now,
    ...
    while True:
        ...
        for calendar_list_entry in calendar_list['items']:
            if 'mirantis.com_iqrn5epep3dunclian026s4c6g@group.calendar.google.com' in calendar_list_entry['id']:
