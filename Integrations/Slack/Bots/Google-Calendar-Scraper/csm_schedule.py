...
def main():
    ...
    events_result = service.events().list(calendarId='mirantis.com_b23tu49jjhefsvjm623512p6n8@group.calendar.google.com', timeMin=now,
    ...
    while True:
        ...
        for calendar_list_entry in calendar_list['items']:
            if 'mirantis.com_b23tu49jjhefsvjm623512p6n8@group.calendar.google.com' in calendar_list_entry['id']:
