...
def main():
    ...
    events_result = service.events().list(calendarId='mirantis.com_4n8tffd8in9ip1lrut9t8j4n7o@group.calendar.google.com', timeMin=now,
    ...
    while True:
        ...
        for calendar_list_entry in calendar_list['items']:
            if 'mirantis.com_4n8tffd8in9ip1lrut9t8j4n7o@group.calendar.google.com' in calendar_list_entry['id']:
